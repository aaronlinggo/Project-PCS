...
namespace Hotel_Harem_SamGun
{
    public partial class FormDataJenisKamar : Form
    {
        ...
        {
            dt = new DataTable();
            query = "SELECT id_jenis_kamar,nama_jenis_kamar,harga_jenis_kamar,status_jenis_kamar FROM jenis_kamar ORDER BY id_jenis_kamar";
        ...
        private void dgvJenisKamar_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dgvJenisKamar.Rows[selectedIdx].Cells[3].Value.ToString() == "1")
            {
                rb1.Checked = true;
            }
            else
        ...
        private void btnHapus_Click(object sender, EventArgs e)
        {
            if (selectedIdx > -1)
            {
                ...
                query = $"UPDATE jenis_kamar SET status_jenis_kamar = 0 WHERE id_jenis_kamar = '{tbID.Text}'";
                cmd = new MySqlCommand(query, conn);
                cmd.ExecuteNonQuery();
